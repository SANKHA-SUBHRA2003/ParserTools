...
function formatInitialParseView(input, maximumStepCount) {
	var result = "<p><b>Sentence to be recognized: </b><input class='form-control' id=\"input\" type=\"text\" size=\"" + input.length + "\" onkeyup=\"resize(this, 1);\" onchange=\"parseInput();\" value=\"" + input + "\"></p>";
	...
	result += "<input type=\"button\" class=\"btn btn-success btn-gerar btn-lg\" value=\"Recognize Input\"><br><br>";
	result += "<br>";
	result += "<table class='table table-bordered'>";
	result += "<thead>";
	result += "<tr><th colspan=\"4\">Input Recognition</th></tr>";
