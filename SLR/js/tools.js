function extend(object, zuper)
{
	_.extend(object, zuper);	
	object.zuper = zuper;
}
...
function assertEquality(expected, actual) {
	if (expected != actual) {
		throw 'Error - Expected: ' + expected + ' but was received: ' + actual;
	}
}	
function assertEquals(expected, actual) {
	if (!expected.equals(actual)) {
		throw 'Error - Expected:: ' + expected + ' however, was received: ' + actual;
	}
}
